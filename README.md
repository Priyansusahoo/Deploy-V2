...
| &nbsp; | &nbsp; |
| --- | ----------- |
| **Objective** | - Deploy the end-to-end application in node.js using Jenkins CICD with GitHub Integration <br>- Trigger Jenkins pipeline automatically once the code is pushed on GitHub |
| **Approach** | - Using Amazon's Elastic Compute Cloud (EC2) for running applications on the Amazon Web Services (AWS) infrastructure <br>- Containerize application by creating Dockerfile<br>- Integrate GitHub with Jenkins using Webhook |
...
![1](https://github.com/Priyansusahoo/Deploy-V2/assets/78722016/5077142d-ba46-40b0-bba0-6e94394ced1e)
